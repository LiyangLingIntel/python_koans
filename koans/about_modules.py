...
class AboutModules(Koan):
    ...
    def test_a_module_can_limit_wildcard_imports(self):
        ...
        # import * will import names in __all__ list, by default __all__ will contain all public names, but if manually
        # modify __all__, only names in __all__ would be imported
