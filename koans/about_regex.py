...
class AboutRegex(Koan):
    ...
    def test_matching_literal_text_how_many(self):
        ...
        m = re.match('Felix', string)  # TIP: match may not be the best option - use search instead
    ...
    def test_matching_any_character(self):
        ...
        change_this_search_string = r'.a[0-9]\.xls'
        self.assertEquals(
    ...
    def test_anything_but_matching(self):
        ...
        change_this_search_string = r'[^nc]am\.xls'
        self.assertEquals(
